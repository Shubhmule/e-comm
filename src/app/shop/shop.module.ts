...
import { AreaProductTypeComponent } from './area-product-type/area-product-type.component';
import { ShopProductsComponent } from './shop-products/shop-products.component';
import { AreaProductCategorywiseComponent } from './area-product-categorywise/area-product-categorywise.component';
import { AreaProductBrandWiseComponent } from './area-product-brand-wise/area-product-brand-wise.component';
import { CustomefilterComponent } from './filtering/customefilter/customefilter.component';
import { ProductDetailsRatingComponent } from "../shared/components/product-details-com/product-details-rating/product-details-rating.component";
...
@NgModule({
  declarations: [
    ...
    AreaProductCategorywiseComponent,
    AreaProductBrandWiseComponent,
  ],
  imports: [
    CommonModule,
    ShopRoutingModule,
